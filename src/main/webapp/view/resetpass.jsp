...
<img src="logo.png" class="logo1">
 ...
 <div id="zoomDiv" class="zoom-effect" >
  ...
  <form class="modal-content animate" style="padding-right: 50px " enctype="multipart/form-data" action="savepassword" method="post">
     
     <div class="h1container animate">
     <img src="line.png"> Reset Password <img src="line.png">
     </div>
     
      <center><h5 style="font-size:large;margin: 10px 0 6px 0; color:rgb(125 119 119)">   Enter the new password</h5></center>

     <div class="container animate">
      <div class="input">
      <input type="text" style="background-color:rgb(133 130 124 / 38%) ;color: rgb(241 229 195);"placeholder="Enter your username" name="username" required>
      <input type="text" style="background-color:rgb(133 130 124 / 38%) ;color: rgb(241 229 195);"placeholder="Enter new password" name="password" required>

      </div>  
      
       <div>
       
        <button type="submit" style="margin-top: 20px;" > Save </button></div><br>
